...
public class Product {
    ...
    public static ObservableList<Product> getAllProducts(){
        ...
        String selectProducts = "select * from supply_chain.product1";
        return getProductList(selectProducts);
    }
    public static ObservableList<Product> getProductsByName(String productName) {

        String selectProducts = String.format("select * from supply_chain.product1 WHERE name like '%%%s%%'", productName.toLowerCase());
         return  getProductList(selectProducts);
